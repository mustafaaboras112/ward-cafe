const workspaceNames={'admin.html':'لوحة الإدارة','accounting.html':'لوحة المحاسبة','pos.html':'نقطة البيع','waiter.html':'مساحة الكارسون','kitchen.html':'المطبخ'};
const requestedWorkspace=workspaceNames[new URLSearchParams(location.search).get('next')];
if(requestedWorkspace){
    document.querySelector('.login-card h2').textContent='دخول '+requestedWorkspace;
    document.title='دخول '+requestedWorkspace+' | ورد';
    document.querySelector('.overline').textContent=requestedWorkspace+' • كافيه ورد';
}
